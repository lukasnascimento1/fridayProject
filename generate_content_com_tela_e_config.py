...
# Coloque sua API_KEY
API_KEY = "AIzaSyAMOy7fXUFey9a_tp6K6F8og_KORioDIZk"
    ...
    with st.spinner("Carregando mensagem"):
        resposta = client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                ...
                top_k=1, # Faz a sample através dos k% tokens mais prováveis de cada iteração; É um valor inteiro;
                top_p=1  # Probabilidade cumulativa de cortar mais dados no sampling das próximas mensagens (menor valor, menos valores diferentes possíveis de ser escolhido a cada iteração)
